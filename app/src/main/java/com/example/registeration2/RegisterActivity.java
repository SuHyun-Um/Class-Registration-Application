        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userID.equals("")){
                    ...
                    dialog = builder.setMessage("ID는 빈칸일수 없습니다.")
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(success){//사용할 수 있는 아이디라면
                                ...
                                dialog = builder.setMessage("사용할수 있는  ID 입니다.")
                                ...
                                dialog = builder.setMessage("사용할수 없는 ID 입니다.")
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(success){//사용할 수 있는 아이디라면
                                ...
                                dialog = builder.setMessage("회원등록에 성공 했습니다.")
